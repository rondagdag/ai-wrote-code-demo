...
## Purpose
This Skill provides frontend development patterns, accessibility standards,
and React best practices for the VoteJam UI — structured for use as GitHub Copilot
custom instructions. Include this in `.github/copilot-instructions.md` when working
on frontend features.
